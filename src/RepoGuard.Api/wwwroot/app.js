...
async function scan(id,b){b.disabled=true;b.textContent='Scanning…';try{await api(`/api/v2/repositories/${id}/scans`,{method:'POST',body:'{}'});await load()}catch(e){alert(e.message)}finally{b.disabled=false;b.textContent='Scan'}}
